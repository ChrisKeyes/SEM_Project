...
# This script will take the categorized data frame (respondent segments have been 
# identified) and generate respective shares.  The results will be stored in a table
# named "PARKshares_table" and will include the share and number of observations 
# within each segment.
